$(document).ready(function() {
    ...
    const dark_theme = function() {
        ...
        $('#dark-theme-toggle').on('click', function(event) {
            ...
            if($('body').hasClass('dark-theme')) {
                localStorage.setItem('theme', 'dark');
                $(this).html('<i class="material-icons-outlined">brightness_4</i><i class="material-icons">brightness_4</i>');
            } else {
                localStorage.setItem('theme', 'light');
                $(this).html('<i class="material-icons-outlined">brightness_2</i><i class="material-icons">brightness_2</i>');
            }
    ...
    if($('body').hasClass('dark-theme')) {
        $('#dark-theme-toggle').html('<i class="material-icons-outlined">brightness_4</i><i class="material-icons">brightness_4</i>');
    }
});
